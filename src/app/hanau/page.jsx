...
import HanauBackdrop from '@/components/hanau/HanauBackdrop';
import HanauRestaurant from '@/components/hanau/HanauRestaurant';
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      >
        ...
        <NavBar />
        <HanauBackdrop filteredData={restaurantData} />
      </div>
      <div className='bg-white flex-1 '>
        <HanauRestaurant filteredData={restaurantData} />
      </div>
      <Footer />
    </div>
  );
