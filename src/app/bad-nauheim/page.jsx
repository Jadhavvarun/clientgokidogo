...
import BadnauheinBackdrop from '@/components/badnauhein/BadnauheinBackdrop';
import BadnauheinRestaurant from '@/components/badnauhein/BadnauheinRestaurant';
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      >
        ...
        <NavBar />
        <BadnauheinBackdrop filteredData={restaurantData} />
      </div>
      <div className='bg-white flex-1 '>
        <BadnauheinRestaurant filteredData={restaurantData} />
      </div>
      <Footer />
    </div>
  );
