...
import VibelBackdrop from '@/components/badvilbel/VibelBackdrop';
import VibelRestaurant from '@/components/badvilbel/VilbelRestaurant';
...
export default function Page() {
  ...
  console.log('restaurantData7777',restaurantData);
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      >
        ...
        <NavBar />
        <VibelBackdrop filteredData={restaurantData} />
      </div>
      <div className='bg-white flex-1 '>
        <VibelRestaurant filteredData={restaurantData} />
      </div>
      <Footer />
    </div>
  );
