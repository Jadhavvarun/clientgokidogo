...
import FrankBackdrop from '@/components/frankfurtammain/FrankBackdrop';
import FrankRestaurant from '@/components/frankfurtammain/FrankRestaurant';
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      >
        ...
        <NavBar />
        <FrankBackdrop filteredData={restaurantData} />
      </div>
      <div className='bg-white flex-1 '>
        <FrankRestaurant filteredData={restaurantData} />
      </div>
      <Footer />
    </div>
  );
