...
const CardDesignBadnauhein = ({Name,Image,Address,Cuisine,EstablishmentType,isActive}) => {
...
const BadnauheinCardList = ({ data }) => {
  ...
  export default BadnauheinCardList;